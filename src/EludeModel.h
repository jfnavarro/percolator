...
class RTModel
{
	public:
		...
		static double* fillAAFeatures(const string & alphabet, const string& pep, double *feat);
		...
		void setinhouseIndexAlphabet(const string & alph) { inhouseIndexAlphabet = alph; }
